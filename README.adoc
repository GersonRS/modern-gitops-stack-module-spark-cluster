...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/secret[kubernetes_secret.git_creds] (resource)
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/secret[kubernetes_secret.minio_secret] (resource)
...
==== [[input_path_known_hosts]] <<input_path_known_hosts,path_known_hosts>>
...
==== [[input_path_ssh]] <<input_path_ssh,path_ssh>>
